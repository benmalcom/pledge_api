...
exports.saveFollower = function (req,res) {
    if(req.body)
    {
        var followerData = {
        ...
        var validation = new ValidatorJs(followerData,rules);
        ...
        if(validation.passes())
        {
            pool.getConnection(function(err,connection){
                ...
                var tagCondition = followerData.tag.toLowerCase() == "follow";
                 ...
                 var data = tagCondition ?  [followerData.mobile_user_id,followerData.report_id,1,dateFormat(new Date(), "yyyy-mm-dd hh:MM:ss"),dateFormat(new Date(), "yyyy-mm-dd hh:MM:ss")]
                     : [parseInt(followerData.report_id,"10"),parseInt(followerData.mobile_user_id,"10")];
                ...
                connection.query(query,data,function(err,result){
                    ...
                    else
                    {
                        ...
                        {
                            console.log(tagCondition ? "Report followed" : "Report unfollowed");
